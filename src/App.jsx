  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path="/forgot-password" element={<ProtectedRoute><ForgotPasswordPage /></ProtectedRoute>} />
        <Route
          exact
        ...
        />
        <Route exact path="/sign-up" element={<ProtectedRoute><SignUpPage /></ProtectedRoute>} />
