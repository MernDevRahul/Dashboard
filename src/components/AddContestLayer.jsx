...
import { useAddContestMutation } from "../redux/services/contestService";
...
const AddContestLayer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("clientPassword", form.clientPassword);
    data.append("clientPhone", form.clientPhone);
    if (file) {
      data.append("contestlogo", file);
    }
    try {
      ...
      alert(error?.data?.message || "Failed to add contest");
    }
  };
  return (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-20">
                    <label
                      ...
                      className="form-label fw-semibold text-primary-light text-sm mb-8"
                    >
                      Client Password <span className="text-danger-600">*</span>
                    </label>
                    <input
                      name="clientPassword"
                      required
...
export default AddContestLayer;
